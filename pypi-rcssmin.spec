...
Source0  : https://files.pythonhosted.org/packages/ce/1f/7201775c62911f17dc510560196160519185abad0357dc30748e884f13c6/rcssmin-1.2.1.tar.gz
...
%prep
%setup -q -n rcssmin-1.2.1
cd %{_builddir}/rcssmin-1.2.1
pushd ..
cp -a rcssmin-1.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739811994
